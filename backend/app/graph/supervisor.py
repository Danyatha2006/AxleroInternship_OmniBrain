...
def search_node(state: OmniBrainState):
    ...
    # Increase retrieval attempt when this node runs.
...
def relevance_router(state: OmniBrainState):
    ...
    Relevant results:
        Continue to vision/context/answer.

    Irrelevant results and retry available:
        Rewrite the query and search again.

    Irrelevant results after maximum attempts:
...
def build_search_graph():
    ...
    # -------------------------
    # Existing Vision → Context → Answer
    # -------------------------
